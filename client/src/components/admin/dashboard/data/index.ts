...
const Menus: MenuItem[] = [
  ...
  { title: "Subjects", src: "subject", path: "/admin/subjects", submenu: false },
  {
    title: "Attendance",
    src: "attendance",
  ...
  { title: "Exams", src: "exam", path: "/admin/exams", submenu: false },
  { title: "Settings", src: "Setting", path: "/admin/settings", submenu: false },
  {
    title: "Log out",
    src: "logout",
    path: "/login",
