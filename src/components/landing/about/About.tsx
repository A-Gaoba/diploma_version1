...
const About = () => {
  return (
    <div className="flex justify-center items-center bg-gradient-to-r from-orange-100 via-blue-200 to-yellow-50 rounded-lg shadow-lg p-8">
      <motion.div
      ...
      >
        <div className="flex flex-col justify-center items-center mb-8">
          <h3 className="text-4xl font-bold text-center text-dark-purple">
            About Us
          </h3>
          <div className=" w-40 h-1 bg-dark-purple"></div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="py-3 px-6 text-lg bg-dark-purple text-white rounded-lg font-bold hover:bg-teal-700 transition duration-300"
            >
              Learn More
            </motion.button>
          </div>
